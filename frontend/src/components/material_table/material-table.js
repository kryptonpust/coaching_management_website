    ...
    if (calculatedProps.editable) {
      if (calculatedProps.editable.onRowAdd) {
        calculatedProps.actions.push({
          icon: calculatedProps.editable.Add
            ? calculatedProps.editable.Add.icon
            : calculatedProps.icons.Add,
          tooltip: localization.addTooltip,
          type: calculatedProps.editable.Add
            ? calculatedProps.editable.Add.type
            : null,
            btnprops: calculatedProps.editable.Add
            ? calculatedProps.editable.Add.btnprops
            : {},
          position: "toolbar",
          onClick: () => {
